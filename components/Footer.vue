<template>
  <transition appear
      ...
      v-bind:css="false"
    >
    <div :class="{'footer': true, 'ready': ready}">
      ...
      <br>
        ...
        <nuxt-link class="primary" to="/code">Code of Conduct</nuxt-link>

        <nuxt-link class="primary" to="/accessibility">A11y</nuxt-link>

        <nuxt-link class="primary" to="/more">⁉️</nuxt-link>
      <br>
